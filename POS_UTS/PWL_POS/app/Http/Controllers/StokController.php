...
class StokController extends Controller
{
    ...
    public function list(Request $request){
            $barangs = StokModel::select('stok_id', 'barang_id', 'user_id', 'stok_tanggal','stok_jumlah','harga_jual')
                ->with('kategori');
            ...
            return DataTables::of($barangs)
                ...
                ->addColumn('aksi', function ($stok) { // menambahkan kolom aksi
                    ...
                    $btn  = '<button onclick="modalAction(\''.url('/barang/' . $stok->barang_id . '/').'\')" class="btn btn-info btn-sm">Detail</button> ';
                    $btn .= '<button onclick="modalAction(\''.url('/barang/' . $stok->barang_id . '/edit_ajax').'\')" class="btn btn-warning btn-sm">Edit</button> ';
                    $btn .= '<button onclick="modalAction(\''.url('/barang/' . $stok->barang_id . '/delete_ajax').'\')" class="btn btn-danger btn-sm">Hapus</button> ';
    ...
    public function create_ajax(){
        $barang = KategoriModel::select('barang_id','barang_nama')->get();
        $user = KategoriModel::select('user_id','user_nama')->get();
