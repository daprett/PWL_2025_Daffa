    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('barang') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <select class="form-control" id="kategori_id" name="kategori_id" required>
                            ...
                            @foreach ($kategori as $item) {{-- Ganti $barang dengan $kategori --}}
                                <option value="{{ $item->kategori_id }}">{{ $item->kategori_nama }}</option> {{-- Ganti $item->kategori dengan $item->kategori_id --}}
                            @endforeach
                        </select>
                        @error('kategori_id')
                ...
                </div> {{-- Tambahkan penutupan div yang hilang --}}
                <div class="form-group row">
